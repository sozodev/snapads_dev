...
function InitGeo() {
  ...
  if (navigator.geolocation) {
    ...
    alert('Geolocation pas supporté ou indisponible.');
  }
}
...
function foundYou(position) {
  ...
  geocoder.geocode({'latLng': latlng}, function(results, status) {
    if (status == google.maps.GeocoderStatus.OK) {
      ...
      if (results[0]) {
       // Récupere Lat et Long de l'adresse
        $("#coord").text("latitude : " + position.coords.latitude+", longitude : " +position.coords.longitude);
